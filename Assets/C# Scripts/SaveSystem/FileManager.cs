...
public static class FileManager
{
    ...
    public static async Task<(bool, T[])> GetAllFilesFromDirectory<T>(string directoryPath, string fileExtension = ".json") where T : struct
    {
    ...
    public async static Task<(bool, T)> LoadInfo<T>(string path, bool decryptFile = true) where T : struct
    {
